...
router.get('/getFavs/:category', version('1.0.0'), controller.getFavProduct);
router.get('/getPurchases', version('1.0.0'),controller.getBoughtProduct)
...
router.get('/getOne/:id', version('1.0.0'), controller.getOneById)
